...
This repository contains my implementations and practical projects on **Gated Recurrent Units (GRUs)** using **TensorFlow** and **Keras**.

The objective of this repository is to understand the complete workflow of sequence modeling and sentiment analysis, including text preprocessing, tokenization, sequence padding, word embeddings, GRU architectures, model training, evaluation, and model checkpointing.

---

# Project Covered

- IMDb Movie Review Sentiment Analysis using Stacked GRU
...
│
├── projects/
│   └── IMDb_Sentiment_Analysis_GRU.py
│
├── README.md
└── requirements.txt
```
...
- Developing Gated Recurrent Unit (GRU) networks
- Building Stacked GRU architectures
- Understanding Update Gate and Reset Gate
- Binary Sentiment Classification
- Using EarlyStopping and ModelCheckpoint callbacks
- Training and evaluating GRU models
